...
let
  ...
  buildNginxHost = containerList:
    ...
    nameValuePair domain {
      ...
      forceSSL = false;
      locations."/" = {
        proxyPass = "http://192.168.0.110:${toString port}";
...
in {
  ...
  config = mkIf cfg.enable {
    ...
    # This will faile because of:
    # acme: error: 400 :: urn:ietf:params:acme:error:rejectedIdentifier :: Invalid identifiers requested :: Cannot issue for "XXX.home.private": Domain name does not end with a valid public suffix (TLD)
    # security.acme = {
      # acceptTerms = true;
      # defaults.email = "Credible3736@byom.de"; # Set your real email
    # };
